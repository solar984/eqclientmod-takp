...
void LoadDebugHack()
{
	...
	// Enable crash dump by adding EnableCrashDump=TRUE to [Defaults] section in eqclient.ini
	EnableCrashDump = false;
	char szResult[255] = {};
	char szDefault[255];
	snprintf(szDefault, 255, "FALSE");
	GetPrivateProfileStringA("Defaults", "EnableCrashDump", szDefault, szResult, 255, "./eqclient.ini");
	if (szResult[0] && (szResult[0] == 'T' || szResult[0] == 't' || szResult[0] == '1'))
	{
